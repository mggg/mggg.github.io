...
## Reports
<ul class="card-list">
  {% assign post_titles = "Top 100 city council structures | Study of the 2024 STV City Council Election in Portland, Oregon | Comparing Electoral Systems for the Massachusetts Legislature | Modeling electoral dynamics for the Portland, Oregon city council | Modeling the Fair Representation Act | Analysis of County Commission Elections in Yakima County, WA | STV Reports in the Pacific Northwest | Election Reform in Lowell, MA | Study of Reform Proposals for Chicago City Council | Study of voting systems for Santa Clara, CA" | split: " | " %}
